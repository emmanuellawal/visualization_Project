...
interface NewYorkDashboardProps {
  housingData: any[];
  rentData: any[];
  vehicleData: any[];
}

const NewYorkDashboard: React.FC<NewYorkDashboardProps> = ({ housingData, rentData, vehicleData }) => {
  const stateVehicleData = vehicleData.filter(d => d.state === 'New York');
...
export default NewYorkDashboard; 